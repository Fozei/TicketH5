    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < n; i++) {
                ...
                str += '</div>';
                str += '<div class="tab-order-li">';
                str += '<p class="tab-order-competition-schedule">座&#8194位&#8194号：</p>';
                str += '<p class="tab-order-competition-schedule-details">' + list[i]['areaName'] + '区' + seatList.line + '排' + seatList.column + '座</p>';
                str += '<p class="clear-clear"></p>';
                str += '</div>';
                str += '<div class="tab-order-li">';
                str += '<p class="tab-order-competition-schedule">数&#12288&#12288量：</p>';
                str += '<p class="tab-order-competition-schedule-details">1张</p>';
                str += '<p class="clear-clear"></p>';
                str += '</div>';
                str += '<div class="tab-order-li">';
                str += '<p class="tab-order-competition-schedule">票&#12288&#12288价：</p>';
